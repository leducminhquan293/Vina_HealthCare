...
exports.DMFeatureServiceSchema = exports.DMFeatureService = void 0;
const mongoose_1 = require("@nestjs/mongoose");
let DMFeatureService = class DMFeatureService {
    price_id;
    name;
    description;
    name_en;
...
], DMFeatureService.prototype, "price_id", void 0);
__decorate([
    (0, mongoose_1.Prop)({ required: true }),
    __metadata("design:type", String)
], DMFeatureService.prototype, "name", void 0);
__decorate([
    (0, mongoose_1.Prop)({ required: true }),
    __metadata("design:type", String)
